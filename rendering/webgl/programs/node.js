...
var NodeProgram = /** @class */ (function (_super) {
    ...
    function NodeProgram(gl) {
        ...
        var adjustedZoomRatioLocation = gl.getUniformLocation(_this.program, "u_adjustedZoomRatio");
        if (adjustedZoomRatioLocation === null)
            throw new Error("NodeProgram: error while getting adjustedZoomRatioLocation");
        _this.adjustedZoomRatioLocation = adjustedZoomRatioLocation;
